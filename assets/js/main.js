...
function initProductDetailsPage() {
  ...
  if (priceUsdEl) priceUsdEl.textContent = `($${product.price.toLocaleString()} USD)`;
  ...
  const waMsg = encodeURIComponent(`Hello NDIGO TECH SOLUTIONS! I am interested in purchasing/inquiring about: ${product.name} (Official Price: ৳ ${bdtPrice.toLocaleString('en-IN')} / $${product.price.toLocaleString()} USD). Please provide technical details and delivery time.`);
